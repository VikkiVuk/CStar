...
public class CStarFunctionVariableDeclarationImpl extends ASTWrapperPsiElement implements CStarFunctionVariableDeclaration {

  public CStarFunctionVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CStarVisitor visitor) {
    visitor.visitFunctionVariableDeclaration(this);
  }
