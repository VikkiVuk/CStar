...
public class CStarComparisonExprImpl extends ASTWrapperPsiElement implements CStarComparisonExpr {

  public CStarComparisonExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CStarComparisonOp> getComparisonOpList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CStarComparisonOp.class);
  }
