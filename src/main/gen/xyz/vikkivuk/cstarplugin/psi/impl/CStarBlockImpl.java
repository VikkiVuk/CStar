...
public class CStarBlockImpl extends ASTWrapperPsiElement implements CStarBlock {

  public CStarBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CStarStatement> getStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CStarStatement.class);
  }
