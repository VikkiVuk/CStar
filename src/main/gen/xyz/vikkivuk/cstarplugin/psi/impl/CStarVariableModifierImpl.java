...
public class CStarVariableModifierImpl extends ASTWrapperPsiElement implements CStarVariableModifier {

  public CStarVariableModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
