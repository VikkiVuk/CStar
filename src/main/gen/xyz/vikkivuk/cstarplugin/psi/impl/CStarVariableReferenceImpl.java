...
public class CStarVariableReferenceImpl extends CStarVariableReferenceMixin implements CStarVariableReference {

  public CStarVariableReferenceImpl(ASTNode node) {
    super(node);
  }
