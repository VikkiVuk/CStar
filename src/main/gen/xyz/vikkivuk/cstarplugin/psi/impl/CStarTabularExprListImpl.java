...
public class CStarTabularExprListImpl extends ASTWrapperPsiElement implements CStarTabularExprList {

  public CStarTabularExprListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CStarVisitor visitor) {
    visitor.visitTabularExprList(this);
  }
