...
public class CStarWhilstStmtImpl extends ASTWrapperPsiElement implements CStarWhilstStmt {

  public CStarWhilstStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CStarVisitor visitor) {
    visitor.visitWhilstStmt(this);
  }
  ...
  @Override
  @NotNull
  public CStarTruthExpr getTruthExpr() {
    return findNotNullChildByClass(CStarTruthExpr.class);
  }
