...
public class CStarCatchBlocksImpl extends ASTWrapperPsiElement implements CStarCatchBlocks {

  public CStarCatchBlocksImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CStarVisitor visitor) {
    visitor.visitCatchBlocks(this);
  }
