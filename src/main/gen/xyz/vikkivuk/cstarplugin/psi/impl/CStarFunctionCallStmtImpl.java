...
public class CStarFunctionCallStmtImpl extends ASTWrapperPsiElement implements CStarFunctionCallStmt {

  public CStarFunctionCallStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CStarFunctionCall getFunctionCall() {
    return findNotNullChildByClass(CStarFunctionCall.class);
  }
