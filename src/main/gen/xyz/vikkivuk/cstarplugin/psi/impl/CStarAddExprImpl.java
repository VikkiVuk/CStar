...
public class CStarAddExprImpl extends ASTWrapperPsiElement implements CStarAddExpr {

  public CStarAddExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CStarMulExpr> getMulExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CStarMulExpr.class);
  }
