...
public class CStarMulExprImpl extends ASTWrapperPsiElement implements CStarMulExpr {

  public CStarMulExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CStarPrimary> getPrimaryList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CStarPrimary.class);
  }
