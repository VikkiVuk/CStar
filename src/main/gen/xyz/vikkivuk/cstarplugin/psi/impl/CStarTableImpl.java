...
public class CStarTableImpl extends ASTWrapperPsiElement implements CStarTable {

  public CStarTableImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public CStarTabularExprList getTabularExprList() {
    return findChildByClass(CStarTabularExprList.class);
  }
