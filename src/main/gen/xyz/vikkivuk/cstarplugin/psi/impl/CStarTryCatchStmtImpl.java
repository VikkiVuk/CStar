...
public class CStarTryCatchStmtImpl extends ASTWrapperPsiElement implements CStarTryCatchStmt {

  public CStarTryCatchStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CStarCatchBlocks getCatchBlocks() {
    return findNotNullChildByClass(CStarCatchBlocks.class);
  }
